...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    final List gridItems = List.generate(90, (i) => "Item $i");
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () {
                              Get.toNamed(MyRouter.restroDetailsScreen);
                            },
                            child: const Text(
                              "See All",
                              style: TextStyle(
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
            ...
            child: Column(
              ...
              children: const [
                CircleAvatar(
                  ...
                  radius: 22.0,
                  foregroundImage: AssetImage(AppAssets.JohnDoe),
                ),
          ...
          ListTile(
            onTap: () {
              Get.toNamed(MyRouter.orderTrackingScreen);
            },
            leading:
                const Icon(Icons.pedal_bike, size: 20.0, color: Colors.white),
          ...
          ListTile(
            onTap: () {
              Get.toNamed(MyRouter.settingsScreen);
            },
            leading:
