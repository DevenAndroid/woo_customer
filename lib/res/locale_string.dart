...
class LocaleString extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        ...
        'en_US': {
          ...
          'setNewPassword': 'Set the new password for your account',
          'setNewPassword1': 'so you can login and access all the features',

          'verification': 'Verification',
          '2StepVerification': '2 Step Verification',
          ...
          'provideMoreDetail':'Could you provide more details about this issue?',

          //search  screen
          'filters':'Filters',
          'searchMiles':'Search miles/price/items',
          ...
          'somethingWrong':'Something went wrong, Please try after some time.',
          'internetNotWorking':'Internet Not working, Please check your internet connection.',
